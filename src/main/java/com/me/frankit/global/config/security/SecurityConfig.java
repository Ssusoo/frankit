package com.me.frankit.global.config.security;

import com.me.frankit.global.config.security.jwt.JwtAccessDeniedHandler;
import com.me.frankit.global.config.security.jwt.JwtAuthenticationEntryPoint;
import com.me.frankit.global.config.security.jwt.JwtAuthenticationFilter;
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		return http
				...
				.authorizeHttpRequests(
						authorize -> authorize
								.requestMatchers(
										"/frankit/signup", "/frankit/login", "/frankit/renew-access-token",
										"/frankit/**", "/h2-console/**", "/v3/api-docs/**"
								).permitAll()
